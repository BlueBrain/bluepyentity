...
from entity_manager.nexus.connector import NexusConnector
from entity_manager.nexus.factory import EntityFactory
...
class NexusHelper:
    ...
    @property
    def factory(self):
        """:py:class:`~entity_manager.nexus.factory.EntityFactory` instance creating the entities."""
    ...
    def get_entity_by_id(self, resource_id, tool=None, **kwargs):
        ...
        Args:
            ...
            tool (str): Name of the tool to open the resource with, or None to use the default tool
                        (see :py:class:`~entity_manager.nexus.factory.EntityFactory.open`).
    ...
    def get_entities_by_query(self, query, tool=None, **kwargs):
        ...
        Returns:
            list: An array of found entities (py:class:~entity_manager.nexus.entity.Entity`).
        """
    ...
    def as_dataframe(self, data, store_metadata=True, **kwargs):
        ...
        Args:
            data (list): List of :py:class:`~entity_manager.nexus.entity.Entity` objects.
